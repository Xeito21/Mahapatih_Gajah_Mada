...
{
    [Header("Archer Info")]
    [SerializeField] private GameObject anakPanahPrefab;
    [SerializeField] private float arrowSpeed;
    [SerializeField] private float arowDamage;
    public float jumpCooldown;
    public float safeDistance;
    [HideInInspector] public float lastTimeJumped;
    public Vector2 jumpVelocity;

    [Header("Behind Collision Check")]
    ...
    {
        GameObject newAnakPanahPrefab = Instantiate(anakPanahPrefab, attackCheck.position, Quaternion.identity);

        newAnakPanahPrefab.GetComponent<Arrow_Controller>().SetupArrow(arrowSpeed * facingDir, stats);
